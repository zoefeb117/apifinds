    ...
    <div className="flex flex-col h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full max-w-md">
            {examplePrompts.map((prompt, index) => (
              <button
                key={index}
                className="text-left p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors text-sm"
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-800">
        <div className="relative">
          <textarea
            ref={textareaRef}
            className="w-full p-3 pr-12 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-black focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white resize-none min-h-[52px] max-h-[200px]"
